...
vim.api.nvim_set_hl(0, "Pmenu", { bg = normal.bg, fg = normal.fg })
vim.api.nvim_set_hl(0, "PmenuSel", { bg = "#456789", fg = normal.fg, bold = true })
vim.api.nvim_set_hl(0, "PmenuKindSel", { bg = "#456789", fg = normal.fg, bold = true })
